            ...
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-semibold text-foreground mb-2">Quality</h4>
                  <p className="text-muted-foreground text-sm">Committed to excellence in every project we undertake</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-primary rounded-full mx-auto mb-4 flex items-center justify-center">
                  ...
                  <p className="text-muted-foreground text-sm">Building lasting relationships through trust and collaboration</p>
                </div>
              </div>
            </CardContent>
          </Card>
