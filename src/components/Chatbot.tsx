...
const Chatbot = () => {
  ...
  // Hover states for contact icons
          ...
          >
            ...
            <div className="relative">
              <Button
                ...
                onClick={() => {
                  window.location.href = 'tel:+916263716688';
                }}
                className="w-12 h-12 rounded-full bg-blue-500 hover:bg-blue-600 shadow-lg relative"
                size="icon"
                aria-label="Call us"
              >
              ...
              {/* Phone Tooltip */}
              {isPhoneHovered && (
                <div className="absolute right-full top-1/2 transform -translate-y-1/2 mr-2 bg-white text-gray-900 text-xs rounded py-1 px-2 whitespace-nowrap z-50 border border-gray-200 shadow-sm">
                  +91 6263716688
                  <div className="absolute right-[-6px] top-1/2 transform -translate-y-1/2 w-0 h-0 border-l-[6px] border-l-white border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent"></div>
                </div>
              )}
            </div>
            ...
            <div className="relative">
              <Button
                ...
                onClick={() => {
                  ...
                  window.open(`https://wa.me/916263716688?text=${text}`, '_blank');
                }}
                className="w-12 h-12 rounded-full bg-green-500 hover:bg-green-600 shadow-lg relative"
                size="icon"
